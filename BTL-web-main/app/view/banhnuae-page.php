...
$totalProducts = $productsModel->countSanpham('BNE');
$totalPages = ceil($totalProducts / $limit);

$result = $productsModel->laySanphamPhanTrang('BNE', $limit, $offset);
?>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="bookmark">
        <div class="content-bookmark">
            <div>
                <h1 style="font-size: 100px;">Bánh Nửa Entremet</h1>
            ...
            <?php if ($result->num_rows > 0): ?>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <div class='product-container'>
                        <a href='index.php?action=showProduct&id=<?php echo $row['MaSP']; ?>'>
    ...
    <ul class="page-numbers" id="pagination">
        <?php if ($page > 1): ?>
            <li><a href="?action=banhnuae&page=<?php echo $page - 1; ?>">« Trước</a></li>
        <?php endif; ?>

        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
            <li>
                <a href="?action=banhnuae&page=<?php echo $i; ?>" 
        ...
        <?php if ($page < $totalPages): ?>
            <li><a href="?action=banhnuae&page=<?php echo $page + 1; ?>">Tiếp »</a></li>
        <?php endif; ?>
    </ul>
</nav>
